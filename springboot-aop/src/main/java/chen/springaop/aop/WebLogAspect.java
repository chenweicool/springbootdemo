...
public class WebLogAspect {
     ...
     * 横切点
     */
    @Pointcut("execution(public * chen.springaop.controller..*.*(..))")
    public void webLog() {
    }
    /**
     * 接收请求，并记录数据
    ...
    public void doBefore(JoinPoint joinPoint, weblog controllerWebLog) {
        // 接收到请求
    ...
    public void doAfterReturning(weblog controllerWebLog, Object ret) throws Throwable {
